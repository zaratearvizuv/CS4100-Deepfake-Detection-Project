...
RESULTS_PATH = "experiments/noise-pattern-v4-experiment-1/cross_test_stylegan2_results.txt"

# StyleGAN2 only has fake images, we borrow real images from StyleGAN1
...
print(f"\nStyleGAN2 Cross-Test Accuracy: {acc:.2f}%")
print(report)

results = f"""Noise Pattern Cross-Test: StyleGAN2
=====================================
Model trained on: StyleGAN1 (real_vs_fake)
Tested on: StyleGAN2 (SFHQ part 3)
