...
RESULTS_PATH = "experiments/dire_cifake_results.txt"
...
print(f"\nDIRE CIFAKE Accuracy: {acc:.2f}%")
print(report)

results = f"""DIRE Results: CIFAKE (Stable Diffusion)
========================================
...
joblib.dump(clf, "experiments/dire_cifake_clf.pkl")
joblib.dump(scaler, "experiments/dire_cifake_scaler.pkl")
