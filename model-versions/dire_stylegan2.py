...
# Paths - StyleGAN2 only has fake images, borrow real from StyleGAN1
FAKE_PATH = "datasets/stylegan2/images/images"
REAL_PATH = "datasets/real_vs_fake/real-vs-fake/test/real"
RESULTS_PATH = "experiments/dire_stylegan2_results.txt"
...
print("\nProcessing StyleGAN2 fake images...")
...
print(f"\nDIRE StyleGAN2 Accuracy: {acc:.2f}%")
print(report)

results = f"""DIRE Results: StyleGAN2
=======================
Dataset: SFHQ part 3 (StyleGAN2)
...
joblib.dump(clf, "experiments/dire_stylegan2_clf.pkl")
joblib.dump(scaler, "experiments/dire_stylegan2_scaler.pkl")
